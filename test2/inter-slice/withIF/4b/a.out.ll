...
if.end.96:                                        ; preds = %lor.lhs.false.92, %while.end.89, %if.then.93
  ...
  %44 = load %struct.GlobalMemory** @Global, align 8
  call void @FFT1D(i32 1, i32 undef, i32 undef, double* undef, double* undef, double* undef, double* undef, i32 undef, i32* %l_transtime, i32 undef, i32 undef, i32 undef, i32 %43, i32 undef, i32 undef, i32 undef, %struct.GlobalMemory* %44)
  ret void
}
...
for.end:                                          ; preds = %for.cond
  ...
  call void @InitializeSwitchesAndCounter()
  call void @IncrementCounter()
  %20 = load %struct.GlobalMemory** %Global.addr, align 8
  %start52 = getelementptr inbounds %struct.GlobalMemory* %20, i32 0, i32 2
  %gsense53 = getelementptr inbounds %struct.barrier_t* %start52, i32 0, i32 0
  %21 = load volatile i32* %gsense53, align 4
  %call7 = call i32 @sleep(i32 1)
  store i32 %21, i32* %lsense51, align 4
  br label %while.body.55

while.body.55:                                    ; preds = %if.end.83, %for.end
  %22 = load %struct.GlobalMemory** %Global.addr, align 8
  %start57 = getelementptr inbounds %struct.GlobalMemory* %22, i32 0, i32 2
  %count58 = getelementptr inbounds %struct.barrier_t* %start57, i32 0, i32 1
  %23 = load volatile i64* %count58, align 8
  %call8 = call i32 @sleep(i32 1)
  %conv59 = trunc i64 %23 to i32
  store i32 %conv59, i32* %oldcount56, align 4
  %24 = load i32* %oldcount56, align 4
  %25 = load i32* %lsense51, align 4
  %add61 = add nsw i32 %24, %25
  store i32 %add61, i32* %newcount60, align 4
  %26 = load i32* %oldcount56, align 4
  %27 = load i32* %newcount60, align 4
  %call63 = call i32 @atomic_cmpxchg(i32 %26, i32 %27)
  %call12 = call i32 @sleep(i32 1)
  store i32 %call63, i32* %updatedcount62, align 4
  %28 = load i32* %updatedcount62, align 4
  %29 = load i32* %oldcount56, align 4
  %cmp64 = icmp eq i32 %28, %29
  br i1 %cmp64, label %if.then.66, label %if.end.83

if.then.66:                                       ; preds = %while.body.55
  %30 = load i32* %newcount60, align 4
  %31 = load i32* %P.addr, align 4
  %cmp67 = icmp eq i32 %30, %31
  br i1 %cmp67, label %land.lhs.true.69, label %lor.lhs.false.72

land.lhs.true.69:                                 ; preds = %if.then.66
  %32 = load i32* %lsense51, align 4
...
while.cond.85:                                    ; preds = %while.body.90, %while.end.84
  %37 = load %struct.GlobalMemory** %Global.addr, align 8
  %start86 = getelementptr inbounds %struct.GlobalMemory* %37, i32 0, i32 2
  %gsense87 = getelementptr inbounds %struct.barrier_t* %start86, i32 0, i32 0
  %38 = load volatile i32* %gsense87, align 4
  %39 = load i32* %lsense51, align 4
  %cmp88 = icmp eq i32 %38, %39
