...
@.str.64 = private unnamed_addr constant [11 x i8] c"ERROR: %s\0A\00", align 1
@.str.61 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@.str.62 = private unnamed_addr constant [13 x i8] c" %4.2f %4.2f\00", align 1
...
land.lhs.true.9:                                  ; No predecessors!
  br label %if.end

if.then.12:                                       ; No predecessors!
  br label %if.end

if.end:                                           ; preds = %land.lhs.true.9, %lor.lhs.false, %land.lhs.true, %if.then, %if.then.12
  br label %while.end
...
while.cond:                                       ; preds = %while.body.20, %while.end
  br label %while.end.21

while.body.20:                                    ; No predecessors!
  br label %while.cond
...
for.cond:                                         ; preds = %for.inc, %if.end.39
  ...
  %12 = load i32* %MyLast.addr, align 4
...
for.end:                                          ; preds = %for.cond
  %14 = load %struct.GlobalMemory** %Global.addr, align 8
  %start52 = getelementptr inbounds %struct.GlobalMemory* %14, i32 0, i32 2
  %gsense53 = getelementptr inbounds %struct.barrier_t* %start52, i32 0, i32 0
  %15 = load volatile i32* %gsense53, align 4
  store i32 %15, i32* %lsense51, align 4
  br label %while.body.55

while.body.55:                                    ; preds = %if.end.83, %for.end
  %16 = load %struct.GlobalMemory** %Global.addr, align 8
  %start57 = getelementptr inbounds %struct.GlobalMemory* %16, i32 0, i32 2
  %count58 = getelementptr inbounds %struct.barrier_t* %start57, i32 0, i32 1
  %17 = load volatile i64* %count58, align 8
  %conv59 = trunc i64 %17 to i32
  store i32 %conv59, i32* %oldcount56, align 4
  %18 = load i32* %oldcount56, align 4
  %19 = load i32* %lsense51, align 4
  %add61 = add nsw i32 %18, %19
  store i32 %add61, i32* %newcount60, align 4
  %20 = load i32* %oldcount56, align 4
  %21 = load i32* %newcount60, align 4
  %call63 = call i32 @atomic_cmpxchg(i32 %20, i32 %21)
  store i32 %call63, i32* %updatedcount62, align 4
  %22 = load i32* %updatedcount62, align 4
  %23 = load i32* %oldcount56, align 4
...
land.lhs.true.69:                                 ; No predecessors!
  br label %if.end.82

lor.lhs.false.72:                                 ; No predecessors!
  br label %if.end.82

land.lhs.true.75:                                 ; No predecessors!
  br label %if.end.82

if.then.78:                                       ; No predecessors!
  br label %if.end.82

if.end.82:                                        ; preds = %land.lhs.true.75, %lor.lhs.false.72, %land.lhs.true.69, %if.then.66, %if.then.78
...
if.end.110:                                       ; preds = %lor.lhs.false.103, %if.end.99, %if.then.105
  %24 = load i32* %MyFirst.addr, align 4
  store i32 %24, i32* %j, align 4
  br label %for.cond.111

for.cond.111:                                     ; preds = %for.inc.131, %if.end.110
  %25 = load i32* %j, align 4
  %26 = load i32* %MyLast.addr, align 4
  %cmp112 = icmp slt i32 %25, %26
...
for.inc.131:                                      ; preds = %if.end.130
  ...
  %inc132 = add nsw i32 %27, 1
  store i32 %inc132, i32* %j, align 4
  br label %for.cond.111

for.end.133:                                      ; preds = %for.cond.111
  %28 = load %struct.GlobalMemory** %Global.addr, align 8
  %start135 = getelementptr inbounds %struct.GlobalMemory* %28, i32 0, i32 2
  %gsense136 = getelementptr inbounds %struct.barrier_t* %start135, i32 0, i32 0
  %29 = load volatile i32* %gsense136, align 4
  store i32 %29, i32* %lsense134, align 4
  br label %while.body.138

while.body.138:                                   ; preds = %if.end.166, %for.end.133
  %30 = load %struct.GlobalMemory** %Global.addr, align 8
  %start140 = getelementptr inbounds %struct.GlobalMemory* %30, i32 0, i32 2
  %count141 = getelementptr inbounds %struct.barrier_t* %start140, i32 0, i32 1
  %31 = load volatile i64* %count141, align 8
  %conv142 = trunc i64 %31 to i32
  store i32 %conv142, i32* %oldcount139, align 4
  %32 = load i32* %oldcount139, align 4
  %33 = load i32* %lsense134, align 4
  %add144 = add nsw i32 %32, %33
  store i32 %add144, i32* %newcount143, align 4
  %34 = load i32* %oldcount139, align 4
  %35 = load i32* %newcount143, align 4
  %call146 = call i32 @atomic_cmpxchg(i32 %34, i32 %35)
  store i32 %call146, i32* %updatedcount145, align 4
  %36 = load i32* %updatedcount145, align 4
  %37 = load i32* %oldcount139, align 4
  %cmp147 = icmp eq i32 %36, %37
...
land.lhs.true.158:                                ; No predecessors!
  br label %if.end.165

if.then.161:                                      ; No predecessors!
  br label %if.end.165

if.end.165:                                       ; preds = %land.lhs.true.158, %lor.lhs.false.155, %land.lhs.true.152, %if.then.149, %if.then.161
...
while.body.173:                                   ; No predecessors!
  br label %while.cond.168
...
if.end.193:                                       ; preds = %lor.lhs.false.186, %if.end.182, %if.then.188
  %38 = load %struct.GlobalMemory** %Global.addr, align 8
  %start195 = getelementptr inbounds %struct.GlobalMemory* %38, i32 0, i32 2
  %gsense196 = getelementptr inbounds %struct.barrier_t* %start195, i32 0, i32 0
  %39 = load volatile i32* %gsense196, align 4
  store i32 %39, i32* %lsense194, align 4
  br label %while.body.198

while.body.198:                                   ; preds = %if.end.226, %if.end.193
  %40 = load %struct.GlobalMemory** %Global.addr, align 8
  %start200 = getelementptr inbounds %struct.GlobalMemory* %40, i32 0, i32 2
  %count201 = getelementptr inbounds %struct.barrier_t* %start200, i32 0, i32 1
  %41 = load volatile i64* %count201, align 8
  %conv202 = trunc i64 %41 to i32
  store i32 %conv202, i32* %oldcount199, align 4
  %42 = load i32* %oldcount199, align 4
  %43 = load i32* %lsense194, align 4
  %add204 = add nsw i32 %42, %43
  store i32 %add204, i32* %newcount203, align 4
  %44 = load i32* %oldcount199, align 4
  %45 = load i32* %newcount203, align 4
  %call206 = call i32 @atomic_cmpxchg(i32 %44, i32 %45)
  store i32 %call206, i32* %updatedcount205, align 4
  %46 = load i32* %updatedcount205, align 4
  %47 = load i32* %oldcount199, align 4
  %cmp207 = icmp eq i32 %46, %47
  br i1 %cmp207, label %if.then.209, label %if.end.226

if.then.209:                                      ; preds = %while.body.198
  br label %if.end.225

land.lhs.true.212:                                ; No predecessors!
  br label %if.end.225

lor.lhs.false.215:                                ; No predecessors!
  br label %if.end.225

land.lhs.true.218:                                ; No predecessors!
  br label %if.end.225

if.then.221:                                      ; No predecessors!
  br label %if.end.225

if.end.225:                                       ; preds = %land.lhs.true.218, %lor.lhs.false.215, %land.lhs.true.212, %if.then.209, %if.then.221
...
while.body.233:                                   ; No predecessors!
  br label %while.cond.228
...
if.end.257:                                       ; preds = %lor.lhs.false.236, %while.end.234, %for.end.256
  ...
  %start259 = getelementptr inbounds %struct.GlobalMemory* %48, i32 0, i32 2
  %gsense260 = getelementptr inbounds %struct.barrier_t* %start259, i32 0, i32 0
  %49 = load volatile i32* %gsense260, align 4
  store i32 %49, i32* %lsense258, align 4
  br label %while.body.262

while.body.262:                                   ; preds = %if.end.290, %if.end.257
  %50 = load %struct.GlobalMemory** %Global.addr, align 8
  %start264 = getelementptr inbounds %struct.GlobalMemory* %50, i32 0, i32 2
  %count265 = getelementptr inbounds %struct.barrier_t* %start264, i32 0, i32 1
  %51 = load volatile i64* %count265, align 8
  %conv266 = trunc i64 %51 to i32
  store i32 %conv266, i32* %oldcount263, align 4
  %52 = load i32* %oldcount263, align 4
  %53 = load i32* %lsense258, align 4
  %add268 = add nsw i32 %52, %53
  store i32 %add268, i32* %newcount267, align 4
  %54 = load i32* %oldcount263, align 4
  %55 = load i32* %newcount267, align 4
  %call270 = call i32 @atomic_cmpxchg(i32 %54, i32 %55)
  store i32 %call270, i32* %updatedcount269, align 4
  %56 = load i32* %updatedcount269, align 4
  %57 = load i32* %oldcount263, align 4
  %cmp271 = icmp eq i32 %56, %57
...
lor.lhs.false.279:                                ; No predecessors!
  br label %if.end.289

land.lhs.true.282:                                ; No predecessors!
  br label %if.end.289

if.then.285:                                      ; No predecessors!
  br label %if.end.289

if.end.289:                                       ; preds = %land.lhs.true.282, %lor.lhs.false.279, %land.lhs.true.276, %if.then.273, %if.then.285
...
while.body.297:                                   ; No predecessors!
  br label %while.cond.292
...
entry:
  %loopID.addr = alloca i32, align 4
  store i32 %loopID, i32* %loopID.addr, align 4
  ret void
}
