...
extern ModulePass* createHelloPass(void);
extern ModulePass* createSlicerPass(void);
//Note:
//createSlicerPass is for interprocedural slicing.
//However, what we need is intraprocedural slicing.
//createFunctionSlicerPass is the corresponding intraprocedural one.
extern ModulePass* createFunctionSlicerPass(void);
...
//  passes.add(createHelloPass());
  passes.add(createUnifyFunctionExitNodesPass());
  passes.add(createSlicerPass());
//  passes.add(createFunctionSlicerPass());
