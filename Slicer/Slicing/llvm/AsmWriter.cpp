...
void AssemblyWriter::printModule(const Module *M) {
  ...
  if (!DL.empty())
#ifdef __LLVM_3_1__
    Out << "target datalayout = \"" << "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128" << "\"\n";
#else
...
//    if(!RetTy->isVoidTy())
    {
      ...
      {
        StringRef funcName = Operand->getName();
        if(funcName == "printf"
            || funcName == "fprintf"
            || funcName == "drand48"
            || funcName == "pthread_self"
            || funcName == "__isoc99_fscanf"
            || funcName == "callee.knr.cast"
            || funcName == "fscanf"
            || funcName == "sscanf"
          )
        {
