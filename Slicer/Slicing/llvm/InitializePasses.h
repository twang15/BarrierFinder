...
void initializeSlicerPass(PassRegistry&); //interprocedural
void initializeFunctionSlicerPass(PassRegistry&); //intraprocedural
void initializeCreateHammockCFGPass(PassRegistry&);
}
