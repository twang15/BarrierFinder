...
; <label>:23                                      ; preds = %19
  ...
  %25 = sub nsw i32 1, %24
  call void @printX()
  store i32 %25, i32* @gsense, align 4
  %call1 = call i32 @sleep(i32 3)
  %26 = load i32* @gsense, align 4
  call void @snapshot(i32 %26, i32 1)
  store i32 0, i32* @counter, align 4
  %27 = load i32* @counter, align 4
  call void @snapshot(i32 %27, i32 0)
...
; <label>:57                                      ; preds = %53
  %58 = load i32* @gsense, align 4
  %59 = sub nsw i32 1, %58
  call void @printX()
  store i32 %59, i32* @gsense, align 4
  %call3 = call i32 @sleep(i32 3)
  %60 = load i32* @gsense, align 4
  call void @snapshot(i32 %60, i32 1)
  store i32 0, i32* @counter, align 4
  %61 = load i32* @counter, align 4
  call void @snapshot(i32 %61, i32 0)
  %62 = call i32 @sleep(i32 1)
  br label %63
