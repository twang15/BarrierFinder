...
; <label>:7                                       ; preds = %30, %0
  ...
  %11 = add nsw i32 %10, 1
  store i32 %11, i32* %newcount, align 4
  %12 = load i32* %oldcount, align 4
  %13 = load i32* %newcount, align 4
  %14 = call i32 @atomic_cmpxchg(i32 %12, i32 %13)
  store i32 %14, i32* %updatedcount, align 4
...
; <label>:23                                      ; preds = %19
  ...
  call void @snapshot(i32 %24, i32 0)
  %25 = call i32 @sleep(i32 1)
  %26 = load i32* @gsense, align 4
  %27 = sub nsw i32 1, %26
  call void @printX()
  store i32 %27, i32* @gsense, align 4
  %call1 = call i32 @sleep(i32 3)
  %28 = load i32* @gsense, align 4
  call void @snapshot(i32 %28, i32 1)
  br label %29
...
; <label>:37                                      ; preds = %32
  call void @printY()
  %38 = call i32 @sleep(i32 4)
  call void @InitializeSwitchesAndCounter(i32 2)
  call void @IncrementCounter()
  %39 = load i32* @gsense, align 4
  store i32 %39, i32* %lsense1, align 4
  %40 = call i32 @sleep(i32 1)
  br label %41

; <label>:41                                      ; preds = %64, %37
  %42 = load i32* @counter, align 4
  store i32 %42, i32* %oldcount2, align 4
  %43 = call i32 @sleep(i32 1)
  %44 = load i32* %oldcount2, align 4
  %45 = add nsw i32 %44, 1
  store i32 %45, i32* %newcount3, align 4
  %46 = load i32* %oldcount2, align 4
  %47 = load i32* %newcount3, align 4
  %48 = call i32 @atomic_cmpxchg(i32 %46, i32 %47)
  store i32 %48, i32* %updatedcount4, align 4
  %49 = call i32 @sleep(i32 1)
  %50 = load i32* %updatedcount4, align 4
  %51 = load i32* %oldcount2, align 4
  %52 = icmp eq i32 %50, %51
  br i1 %52, label %53, label %64

; <label>:53                                      ; preds = %41
  %54 = load i32* %newcount3, align 4
...
; <label>:57                                      ; preds = %53
  store i32 0, i32* @counter, align 4
  %58 = load i32* @counter, align 4
  call void @snapshot(i32 %58, i32 0)
  %59 = call i32 @sleep(i32 1)
  %60 = load i32* @gsense, align 4
  %61 = sub nsw i32 1, %60
  call void @printX()
  store i32 %61, i32* @gsense, align 4
  %call3 = call i32 @sleep(i32 3)
  %62 = load i32* @gsense, align 4
  call void @snapshot(i32 %62, i32 1)
  br label %63
...
; <label>:66                                      ; preds = %70, %65
  %67 = load i32* @gsense, align 4
  %68 = load i32* %lsense1, align 4
