...
; <label>:8                                       ; preds = %30, %0
  %9 = load i32* @counter, align 4
  store i32 %9, i32* %oldcount, align 4
...
; <label>:24                                      ; preds = %20
  ...
  call void @snapshot(i32 %25, i32 0)
...
; <label>:37                                      ; preds = %32
  ...
  call void @IncrementCounter()
  store i32 1, i32* %lsense1, align 4
  %39 = load i32* %lsense1, align 4
  %40 = sub nsw i32 1, %39
  store i32 %40, i32* %lsense1, align 4
  br label %41
...
; <label>:57                                      ; preds = %53
  ...
  %60 = load i32* %lsense1, align 4
  call void @printX()
  store i32 %60, i32* @gsense, align 4
  %call3 = call i32 @sleep(i32 3)
  %61 = load i32* @gsense, align 4
