...
cd $HOME/BarrierFinder//splash2/codes/kernels/cholesky
setEnv37
...
Debug+Asserts/bin/c9-worker -disable-opt --stand-alone -debug-sched-history -fork-on-schedule --posix-runtime --output-dir=test-prod-cons $HOME/BarrierFinder//BarrierFinder/splash2/cholesky/a.out.bc
