...
InitTaskQueues(P)
{
  ...
  tasks = (struct taskQ *) MyMalloc(P*sizeof(struct taskQ), 888);
  for (i=0; i<P; i++) {
    {pthread_mutex_init(&(tasks[i].taskLock), ((void*)0));}

    tasks[i].taskQ = (struct Task *) ((void*)0);
    tasks[i].taskQlast = (struct Task *) ((void*)0);
    tasks[i].probeQ = (struct Task *) ((void*)0);
    tasks[i].probeQlast = (struct Task *) ((void*)0);
    }
}
...
struct LocalCopies *lc;
{
  return(tasks[MyNum].taskQ != ((void*)0));
}
