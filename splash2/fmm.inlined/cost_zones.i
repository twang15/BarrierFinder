...
static int Direction_Sequence[4][4] =
{
   { UP, RIGHT, RIGHT, DOWN },
   { DOWN, LEFT, LEFT, UP },
   { RIGHT, UP, UP, LEFT },
...
void CostZones_1 (int my_id)
{
  PartitionIterate(my_id, ComputeSubTreeCosts, BOTTOM);
}

void CostZones_2 (int my_id)
{
...
CostZonesHelper (int my_id, box *b, int work, direction dir)
{
  ...
  InsertBoxInPartition(my_id, b);
      ...
      for (i = 0; (i < 4) && (work < Local[my_id].Max_Work);
    i++) {
