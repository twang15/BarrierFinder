...
InitGlobalMemory ()
{
   ...
   G_Memory->count = 0;
   G_Memory->id = 0;
   {pthread_mutex_init(&(G_Memory->io_lock), ((void*)0));};
   {pthread_mutex_init(&(G_Memory->mal_lock), ((void*)0));};
   {pthread_mutex_init(&(G_Memory->single_lock), ((void*)0));};
   {pthread_mutex_init(&(G_Memory->count_lock), ((void*)0));};
   {int i; for (i = 0; i < (2048); i++)
    pthread_mutex_init(&((G_Memory->lock_array)[i]), ((void*)0));};
   {
  (G_Memory->synch).gsense=1;
  (G_Memory->synch).count=0;
  };
   G_Memory->max_x = -2.221e308;
   G_Memory->min_x = 2.221e308;
   G_Memory->max_y = -2.221e308;
   G_Memory->min_y = 2.221e308;
}
