...
TRI *pt;
 ...
 minx = miny = minz = 1e+32;
 maxx = maxy = maxz = -1e+32;
 ...
 for (i = 0; i < 3; i++)
  ...
  minx = ( (minx) < ((*vptr)[0]) ? (minx) : ((*vptr)[0]) );
  miny = ( (miny) < ((*vptr)[1]) ? (miny) : ((*vptr)[1]) );
  minz = ( (minz) < ((*vptr)[2]) ? (minz) : ((*vptr)[2]) );

  maxx = ( (maxx) > ((*vptr)[0]) ? (maxx) : ((*vptr)[0]) );
  maxy = ( (maxy) > ((*vptr)[1]) ? (maxy) : ((*vptr)[1]) );
  maxz = ( (maxz) > ((*vptr)[2]) ? (maxz) : ((*vptr)[2]) );
...
OBJECT *po;
 ...
 for (i = 0; i < po->numelements; i++)
  ...
  minx = ( (minx) < (pe->bv.dnear[0]) ? (minx) : (pe->bv.dnear[0]) );
  miny = ( (miny) < (pe->bv.dnear[1]) ? (miny) : (pe->bv.dnear[1]) );
  minz = ( (minz) < (pe->bv.dnear[2]) ? (minz) : (pe->bv.dnear[2]) );

  maxx = ( (maxx) > (pe->bv.dfar[0]) ? (maxx) : (pe->bv.dfar[0]) );
  maxy = ( (maxy) > (pe->bv.dfar[1]) ? (maxy) : (pe->bv.dfar[1]) );
  maxz = ( (maxz) > (pe->bv.dfar[2]) ? (maxz) : (pe->bv.dfar[2]) );
...
POINT Ni;
 ...
 if (pt->norminterp)
  ...
  { Ni[0] = pt->norm[0]; Ni[1] = pt->norm[1]; Ni[2] = pt->norm[2]; };
 }
# 344 "tri.c"
...
MATRIX normMat;
 ...
 while (coord[0] != 1e+32 && coord[1] != 1e+32 && coord[2] != 1e+32)
  {
...
IRECORD *hit;
 ...
 Rd_dot_Pn = ( pt->norm[0]*pr->D[0] + pt->norm[1]*pr->D[1] + pt->norm[2]*pr->D[2] );

 if (( (Rd_dot_Pn) > 0.0 ? (Rd_dot_Pn) : -(Rd_dot_Pn) ) < 1e-07)
  return (0);

 Ro_dot_Pn = ( pt->norm[0]*pr->P[0] + pt->norm[1]*pr->P[1] + pt->norm[2]*pr->P[2] );
 ...
 switch (pt->indx)
  ...
  case 1:
   ...
   if (!(((pt->norm[0]) <= 0.0 && (hit->b1) >= (pt->norm[0]) && (hit->b1) <= 0.0) || ((pt->norm[0]) > 0.0 && (hit->b1) >= 0.0 && (hit->b1) <= (pt->norm[0]))))
    return (0);

   hit->b2 = e3[1] * (q2 - (*v3)[2]) - e3[2] * (q1 - (*v3)[1]);
   if (!(((pt->norm[0]) <= 0.0 && (hit->b2) >= (pt->norm[0]) && (hit->b2) <= 0.0) || ((pt->norm[0]) > 0.0 && (hit->b2) >= 0.0 && (hit->b2) <= (pt->norm[0]))))
    return (0);

   hit->b3 = e1[1] * (q2 - (*v1)[2]) - e1[2] * (q1 - (*v1)[1]);
   if (!(((pt->norm[0]) <= 0.0 && (hit->b3) >= (pt->norm[0]) && (hit->b3) <= 0.0) || ((pt->norm[0]) > 0.0 && (hit->b3) >= 0.0 && (hit->b3) <= (pt->norm[0]))))
    return (0);
   break;
  ...
  case 2:
   ...
   if (!(((pt->norm[1]) <= 0.0 && (hit->b1) >= (pt->norm[1]) && (hit->b1) <= 0.0) || ((pt->norm[1]) > 0.0 && (hit->b1) >= 0.0 && (hit->b1) <= (pt->norm[1]))))
    return (0);

   hit->b2 = e3[2] * (q1 - (*v3)[0]) - e3[0] * (q2 - (*v3)[2]);
   if (!(((pt->norm[1]) <= 0.0 && (hit->b2) >= (pt->norm[1]) && (hit->b2) <= 0.0) || ((pt->norm[1]) > 0.0 && (hit->b2) >= 0.0 && (hit->b2) <= (pt->norm[1]))))
    return (0);

   hit->b3 = e1[2] * (q1 - (*v1)[0]) - e1[0] * (q2 - (*v1)[2]);
   if (!(((pt->norm[1]) <= 0.0 && (hit->b3) >= (pt->norm[1]) && (hit->b3) <= 0.0) || ((pt->norm[1]) > 0.0 && (hit->b3) >= 0.0 && (hit->b3) <= (pt->norm[1]))))
    return (0);
   break;
  ...
  case 3:
   ...
   if (!(((pt->norm[2]) <= 0.0 && (hit->b1) >= (pt->norm[2]) && (hit->b1) <= 0.0) || ((pt->norm[2]) > 0.0 && (hit->b1) >= 0.0 && (hit->b1) <= (pt->norm[2]))))
    return (0);

   hit->b2 = e3[0] * (q2 - (*v3)[1]) - e3[1] * (q1 - (*v3)[0]);
   if (!(((pt->norm[2]) <= 0.0 && (hit->b2) >= (pt->norm[2]) && (hit->b2) <= 0.0) || ((pt->norm[2]) > 0.0 && (hit->b2) >= 0.0 && (hit->b2) <= (pt->norm[2]))))
    return (0);

   hit->b3 = e1[0] * (q2 - (*v1)[1]) - e1[1] * (q1 - (*v1)[0]);
   if (!(((pt->norm[2]) <= 0.0 && (hit->b3) >= (pt->norm[2]) && (hit->b3) <= 0.0) || ((pt->norm[2]) > 0.0 && (hit->b3) >= 0.0 && (hit->b3) <= (pt->norm[2]))))
    return (0);
   break;
  }


 { (hit)->t = tval; (hit)->pelem = pe; };
 return (1);
 }
# 564 "tri.c"
...
MATRIX xinvT;
 ...
 for (i = 0; i < numelems; i++)
  ...
  vindex++;
  vp2 = vptr + (*vindex);
  { vec1[0] = (*vp2)[0] - (*vp1)[0]; vec1[1] = (*vp2)[1] - (*vp1)[1]; vec1[2] = (*vp2)[2] - (*vp1)[2]; };

  vindex++;
  vp3 = vptr + (*vindex);
  { vec2[0] = (*vp3)[0] - (*vp1)[0]; vec2[1] = (*vp3)[1] - (*vp1)[1]; vec2[2] = (*vp3)[2] - (*vp1)[2]; };

  { pt->norm[0] = vec1[1]*vec2[2] - vec1[2]*vec2[1]; pt->norm[1] = vec1[2]*vec2[0] - vec1[0]*vec2[2]; pt->norm[2] = vec1[0]*vec2[1] - vec1[1]*vec2[0]; };
  ...
  if (pt->norminterp)
   ...
   { pnorm[0] = pt->norm[0]; pnorm[1] = pt->norm[1]; pnorm[2] = pt->norm[2]; };
   VecNorm(pnorm);

   if (( pnorm[0]*(*np)[0] + pnorm[1]*(*np)[1] + pnorm[2]*(*np)[2] ) >= 0.0)
    pt->vorder = 1;
   else
    {
    pt->vorder = 2;
    { pt->norm[0] = -1.0 * pt->norm[0]; pt->norm[1] = -1.0 * pt->norm[1]; pt->norm[2] = -1.0 * pt->norm[2]; };
    pt->d = -pt->d;
    }
   }
  ...
  norm[0] = ( (pt->norm[0]) > 0.0 ? (pt->norm[0]) : -(pt->norm[0]) );
  norm[1] = ( (pt->norm[1]) > 0.0 ? (pt->norm[1]) : -(pt->norm[1]) );
  norm[2] = ( (pt->norm[2]) > 0.0 ? (pt->norm[2]) : -(pt->norm[2]) );
