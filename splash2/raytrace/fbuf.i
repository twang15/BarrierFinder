...
CHAR *PicFileName;
 ...
 for (y = 0; y < Display.yres; y++)
  ...
  for (x = 0; x < Display.xres; x++)
   {
   fb[x].r = ( (fb[x].r) < (1.0) ? (fb[x].r) : (1.0) );
   fb[x].g = ( (fb[x].g) < (1.0) ? (fb[x].g) : (1.0) );
   fb[x].b = ( (fb[x].b) < (1.0) ? (fb[x].b) : (1.0) );
   fb[x].r = ( (fb[x].r) > (0.0) ? (fb[x].r) : (0.0) );
   fb[x].g = ( (fb[x].g) > (0.0) ? (fb[x].g) : (0.0) );
   fb[x].b = ( (fb[x].b) > (0.0) ? (fb[x].b) : (0.0) );
   }
