...
if.end.133:                                       ; preds = %if.end.132, %if.end.104
  ...
  %mul142 = mul nsw i32 %47, %48
  %add143 = add nsw i32 %46, %mul142
...
if.then.205:                                      ; No predecessors!
  br label %if.end.210

if.else.208:                                      ; No predecessors!
  br label %if.end.210

if.end.210:                                       ; preds = %if.end.189, %if.else.208, %if.then.205
  %61 = load %struct.GlobalMemory** @Global, align 8
  %start215 = getelementptr inbounds %struct.GlobalMemory* %61, i32 0, i32 2
  ...
  %start216 = getelementptr inbounds %struct.GlobalMemory* %62, i32 0, i32 2
...
if.then.220:                                      ; No predecessors!
  br label %if.end.222

if.end.222:                                       ; preds = %if.end.210, %if.then.220
  br label %if.end.227

if.then.224:                                      ; No predecessors!
  br label %if.end.227

if.end.227:                                       ; preds = %if.end.222, %if.then.224
  store i32 2, i32* @P
...
for.end:                                          ; preds = %for.cond
  ...
  %tobool236 = icmp ne i32 %67, 0
  br i1 %tobool236, label %if.then.237, label %if.end.245

if.then.237:                                      ; preds = %for.end
  br label %if.end.243

if.then.239:                                      ; No predecessors!
  br label %if.end.243

if.else.241:                                      ; No predecessors!
  br label %if.end.243

if.end.243:                                       ; preds = %if.then.237, %if.else.241, %if.then.239
  %call244 = call i32 @PrintArray(i32 undef, double* undef)
  br label %if.end.245
...
for.body.299:                                     ; No predecessors!
  br label %if.end.308

if.then.304:                                      ; No predecessors!
  br label %if.end.308

if.end.308:                                       ; preds = %for.body.299, %if.then.304
  br label %if.end.318

if.then.314:                                      ; No predecessors!
  br label %if.end.318

if.end.318:                                       ; preds = %if.end.308, %if.then.314
  br label %if.end.328

if.then.324:                                      ; No predecessors!
  br label %if.end.328

if.end.328:                                       ; preds = %if.end.318, %if.then.324
  br label %if.end.338

if.then.334:                                      ; No predecessors!
  br label %if.end.338

if.end.338:                                       ; preds = %if.end.328, %if.then.334
  br label %if.end.360

if.then.350:                                      ; No predecessors!
  br label %if.end.360

if.end.360:                                       ; preds = %if.end.338, %if.then.350
  br label %if.end.382

if.then.372:                                      ; No predecessors!
  br label %if.end.382

if.end.382:                                       ; preds = %if.end.360, %if.then.372
...
if.end.431:                                       ; preds = %if.end.245, %for.end.419
  %68 = load i32* @test_result, align 4
  %tobool455 = icmp ne i32 %68, 0
  br i1 %tobool455, label %if.then.456, label %if.end.470

if.then.456:                                      ; preds = %if.end.431
  %call457 = call double @CheckSum(i32 undef, double* undef)
  br label %if.end.469

if.then.465:                                      ; No predecessors!
  br label %if.end.469

if.else.467:                                      ; No predecessors!
  br label %if.end.469

if.end.469:                                       ; preds = %if.then.456, %if.else.467, %if.then.465
  br label %if.end.470
