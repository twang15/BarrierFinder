...

{
  ...
  x = (double *) (((long) x) + PAGE_SIZE - ((long) x) % PAGE_SIZE);
  printf("x: %p\n", x);
  ...
  trans = (double *) (((long) trans) + PAGE_SIZE - ((long) trans) % PAGE_SIZE);
  umain2 = (double *) (((long) umain2) + PAGE_SIZE - ((long) umain2) % PAGE_SIZE);
