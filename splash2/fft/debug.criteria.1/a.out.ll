...
%struct.GlobalMemory = type { i32, i32, %union.pthread_mutex_t, %struct.barrier_t, i32*, i32*, i32, i32, i32 }
...
if.end.211:                                       ; preds = %if.end.188, %if.else.209, %if.then.206
  ...
  %start216 = getelementptr inbounds %struct.GlobalMemory* %61, i32 0, i32 3
  ...
  %start217 = getelementptr inbounds %struct.GlobalMemory* %62, i32 0, i32 3
...
entry:
  ...
  %start = getelementptr inbounds %struct.GlobalMemory* %0, i32 0, i32 3
...
if.then:                                          ; preds = %entry
  ...
  %start3 = getelementptr inbounds %struct.GlobalMemory* %5, i32 0, i32 3
...
if.else:                                          ; preds = %entry
  ...
  %start5 = getelementptr inbounds %struct.GlobalMemory* %7, i32 0, i32 3
...
while.body:                                       ; preds = %if.end.21, %entry
  ...
  %start6 = getelementptr inbounds %struct.GlobalMemory* %2, i32 0, i32 3
...
if.then.18:                                       ; preds = %land.lhs.true.15, %land.lhs.true
  ...
  %start19 = getelementptr inbounds %struct.GlobalMemory* %16, i32 0, i32 3
...
while.cond:                                       ; preds = %while.body.26, %while.end
  ...
  %start22 = getelementptr inbounds %struct.GlobalMemory* %17, i32 0, i32 3
