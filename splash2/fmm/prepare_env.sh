...
cd /home/tao/splash2/codes/apps/fmm
setEnv37
...
Debug+Asserts/bin/c9-worker -disable-opt --stand-alone -debug-sched-history -fork-on-schedule --posix-runtime --output-dir=test-prod-cons /home/tao/CodeWalk/splash2/fmm/a.out.bc
