...
cd $HOME/BarrierFinder//splash2/codes/apps/fmm
setEnv37
...
#sed -i "872s/^/;/ ; 1078s/^/;/ ; 3197s/^/;/" a.out.ll
...
Debug+Asserts/bin/c9-worker -disable-opt --stand-alone -debug-sched-history -fork-on-schedule --posix-runtime --output-dir=test-prod-cons $HOME/BarrierFinder//BarrierFinder/splash2/fmm/a.out.bc
