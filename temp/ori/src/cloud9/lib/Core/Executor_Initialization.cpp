...
void Executor::initRootState(ExecutionState *state,
  ...
  //the root state is considered as the first invariant state.
  //and a directDescendent of Nothing.
  ...
  //Even we set it to false initially, it will
  //be set to true in handleCheckInvariant.
